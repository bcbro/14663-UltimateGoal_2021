...
@Autonomous(name="AutoRouteWobbleFour", group="Auto")
public class AutoRouteFour extends LinearOpMode {
    //
...
//        initRing();
        ...
        outake2.setPIDFCoefficients(DcMotorEx.RunMode.RUN_USING_ENCODER, new PIDFCoefficients(40, 0, 5, 13));
...
//        moveToPosition(2, 0.5);
        ...
        double distance= 61.65;
        moveToPosition(-distance, 0.35);
        turnWithGyro(90, -0.3);
        dropWobble();
        turnWithGyro(90, 0.3);
        spinner.setPower(-1.00);
        moveToPosition(distance+40, 0.42);
        sleep(500);
        turnWithGyro(20, 0.3);
        pickWobble();
        arm.setPower(-0.6);
        ...
        spinner.setPower(0.00);
        turnWithGyro(180,0.3);
        chuckWobble();
    }

    private void chuckWobble() {
        arm.setPower(1.0);
        sleep(250);
