...
@Autonomous(name="AutoRouteWobbleOne", group="Auto")
public class AutoRouteOne extends LinearOpMode {
    //
    DcMotor frontleft;
    DcMotor frontright;
    DcMotor backleft;
...
//        initRing();
        ...
        intake=hardwareMap.dcMotor.get("spinner");
        ...
        //
        wobbleGoalUno.setPosition(0.00);
        wobbleGoalTres.setPosition(1.0);
...
//
        ...
        spinner2.setPower(-0.50);

//        moveToPosition(-2, 0.5);
        ...
        moveToPosition(22, 0.5);// drive forward to go to square

        strafeToPosition(17, 0.3);// strafe to the right to position to shoot

        dropWobble();
        turnWithGyro(15, -0.5);
//        intake.setPower(1.00);
        moveToPosition(-70.5, 0.7);
//        intake.setPower(0.00);
        turnWithGyro(90, -0.3);
        moveToPosition(11, 0.5);
        pickWobble();
        turnWithGyro(90, 0.3);
        spinner.setPower(1.00);
        moveToPosition(63.5, 0.7);
        dropWobble();
    }
